# System Mechanics Specification v1.4 - Documentation Index
...
```
System Mechanics Specification v1.4
│
...
│   ├─ Lexical grammar
│   ├─ UI Composition grammar (NEW v1.4)
│   └─ Experience grammar (NEW v1.4)
│
...
│   ├─ Anti-patterns
│   ├─ End-to-end examples
│   └─ UI Composition examples (NEW v1.4)
│
...
│   └─ UI Composition runtime (NEW v1.4)
│
...
│   └─ UI runtime implementation (NEW v1.4)
│
...
│   ├─ Failure invariants
│   ├─ Addendum U: Composition Semantics (NEW v1.4)
│   ├─ Addendum V: Experience Semantics (NEW v1.4)
│   └─ Addendum W: Field Permissions (NEW v1.4)
│
...
│   ├─ Troubleshooting
│   ├─ Quick lookup tables
│   ├─ UI Composition cheat sheet (NEW v1.4)
│   └─ Experience cheat sheet (NEW v1.4)
│
...
└─ Appendix-H-Worked-Banking-Example.md ⭐ UPDATED v1.4
    ...
    ├─ Customer Experience (NEW v1.4)
    ├─ Administrator Experience (NEW v1.4)
    └─ Full UI Composition example (NEW v1.4)
```
...
**Completeness**: 99% (v1.4 scope)
**Stability**: High (grammar frozen for v1.x)
**Implementation**: Reference runtime available

**v1.4 Additions**:
- PresentationComposition for semantic view grouping
- Experience for application-level navigation
- Field permissions with visibility and masking
- Navigation purposes and scopes
- Indicators for dynamic navigation state
- Complete banking example with customer and admin UI
- Addendums U, V, W for UI semantics

**Next Version (v1.5)** may include:
