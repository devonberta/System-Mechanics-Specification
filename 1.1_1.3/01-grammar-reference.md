# System Mechanics Specification - Grammar Reference v1.3

## Overview

This document provides the complete formal grammar for the Unified System Specification, covering Data, Evolution, UI, Input, Flow (SMS), Worker Topology (WTS), Policy, Signals, Scheduling, Authority, and Multi-Region Survivability.
